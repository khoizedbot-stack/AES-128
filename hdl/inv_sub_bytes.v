...
// Description: Inverse SubBytes — apply inverse S-Box to all 16 bytes
//              Same bit ordering as sub_bytes.v
//==============================================================================
`timescale 1ns / 1ps
...
module inv_sub_bytes (
    ...
    always @* begin
        out_next[  7:  0] = inv_sbox(state_isb_in[  7:  0]);
        out_next[ 15:  8] = inv_sbox(state_isb_in[ 15:  8]);
        out_next[ 23: 16] = inv_sbox(state_isb_in[ 23: 16]);
        out_next[ 31: 24] = inv_sbox(state_isb_in[ 31: 24]);
        out_next[ 39: 32] = inv_sbox(state_isb_in[ 39: 32]);
        out_next[ 47: 40] = inv_sbox(state_isb_in[ 47: 40]);
        out_next[ 55: 48] = inv_sbox(state_isb_in[ 55: 48]);
        out_next[ 63: 56] = inv_sbox(state_isb_in[ 63: 56]);
        out_next[ 71: 64] = inv_sbox(state_isb_in[ 71: 64]);
        out_next[ 79: 72] = inv_sbox(state_isb_in[ 79: 72]);
        out_next[ 87: 80] = inv_sbox(state_isb_in[ 87: 80]);
        out_next[ 95: 88] = inv_sbox(state_isb_in[ 95: 88]);
        out_next[103: 96] = inv_sbox(state_isb_in[103: 96]);
        out_next[111:104] = inv_sbox(state_isb_in[111:104]);
        out_next[119:112] = inv_sbox(state_isb_in[119:112]);
        out_next[127:120] = inv_sbox(state_isb_in[127:120]);
    end

    assign state_isb_out = out_next;
