...
REM
REM Generated by Vivado on Fri Feb 06 21:27:55 +0700 2026
...
echo "xvlog --incr --relax -prj tb_aes128_axi_vlog.prj"
call xvlog  --incr --relax -prj tb_aes128_axi_vlog.prj -log xvlog.log
